...
import {Text, View, StyleSheet, TouchableOpacity, StatusBar, ActivityIndicator} from 'react-native';
        ...
        <KeyboardAwareScrollView enableOnAndroid={true} contentContainerStyle={styles.contentContainer}>
          <View style={styles.container}>
            ...
            <View style={{flex: 3, width: '100%', justifyContent: 'center', marginTop: 20}}>
              ...
              <FormElementTwo placeholder="Email"
                              onChangeText={(text) => this.setState({email: {text}})}></FormElementTwo>
              <PasswordElementTwo placeholder="Password" onChangeText={(text) => {
              ...
              <LoginFooter content="Don't have an account?  " clickableContent=" Sign up"
                           onPress={() => this.signUp()}/>
            </View>
            <View style={{flex: 2}}>
            </View>
